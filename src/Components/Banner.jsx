...
function Banner({query, handleInputChange, handleSearch}) {
return (
        ...
        <form onSubmit={handleSearch}>
            <div className='flex justify-center md:flex-row flex-col md:gap-0 gap-4'>
                ...
                foucs-within:ring-inset foucs-within:ring-indigo-600 md:w-1/2 w-full'> 
                    <input type='text' name='title' id='title' placeholder='Enter your link' className='block flex-1 bg-transparent
