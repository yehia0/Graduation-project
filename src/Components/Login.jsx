    ...
    <div className="max-w-sm w-full text-gray-600 space-y-8">
        <div className="text-center">
            <div className="mt-5 space-y-2">
                ...
                <p className="">Don't have an account? <a href="javascript:void(0)" className="font-medium text-indigo-600 hover:text-indigo-500"><Link to={"/Sign-up"}>Sign up</Link></a></p>
            </div>
        </div>
        <form
        ...
        <div className="text-center">
            <a href="javascript:void(0)" className="text-indigo-600 hover:text-indigo-500"><Link to={"./ForgetPassword"}>Forgot password?</Link></a>
        </div>
    </div>
</main>
)
